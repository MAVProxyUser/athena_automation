...
class LNavfnPlanner : public nav2_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  /**
   * @brief set limited searching regions
   * @param start int of map coordinate
   * @param end int of map coordinate
   */
  void setSearchArea (int *start, int *goal);

  /**
   * @brief clear costarr around given pose
   * @param goal Global pose
   */
  void setFreeArea (int *goal);

  /**
   * @brief visualize the costmap of searching
   */
  void visualize ();

  // Planner based on ROS1 LNavFn algorithm
  std::unique_ptr<LNavFn> planner_;
