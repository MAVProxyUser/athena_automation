...
1.0.0 (2021-08-05)
------------------
* Adjust parameters to suit navigation of the dog
* Add ultrasound data for obstacle avoidance
* Remove timeout while transform in tf2
* smooth the output velocity
* Fix wrong transform the robot pose from global frame to plan frame in function pruneGlobalPlan
