...
configurable_parameters = [{'name': 'serial_no',                    'default': '', 'description': 'choose device by serial number'},
                           ...
                           {'name': 'json_file_path',               'default': '/opt/ros2/dobot/share/realsense2_camera/launch/HighResHighAccuracyPreset-AE1000.json', 'description': 'allows advanced configuration'},    
