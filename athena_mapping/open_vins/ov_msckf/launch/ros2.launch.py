...
configurable_parameters = [
        ...
        {'name': 'cam1_wh', 'default': '[640, 480]'},
        {'name': 'cam0_is_fisheye', 'default': 'false' },
        {'name': 'cam1_is_fisheye', 'default': 'false' },
        {'name': 'cam0_k',  'default': '[388.3648681640625,388.3648681640625,319.376953125,240.9917755126953]'},
        {'name': 'cam0_d',  'default': '[0.0, 0.0, 0.0, 0.0]'},
        {'name': 'cam1_k',  'default': '[388.3648681640625,388.3648681640625,319.376953125,240.9917755126953]'},
        {'name': 'cam1_d',  'default': '[0.0, 0.0, 0.0, 0.0]'},
        {'name': 'T_C0toI', 'default': '[1.0, 0.0, 0.0, -0.03, \
                                         0.0, 1.0, 0.0, 0.007, \
                                         0.0, 0.0, 1.0, 0.016, \
                                         0.0, 0.0, 0.0, 1.0]'},
        {'name': 'T_C1toI', 'default': '[1.0, 0.0, 0.0, 0.065, \
                                         0.0, 1.0, 0.0, 0.007, \
                                         0.0, 0.0, 1.0, 0.016, \
                                         0.0, 0.0, 0.0, 1.0]'}]
...
def generate_launch_description():
    ...
    return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
        launch_ros.actions.Node(
            ...
            name='ov_msckf',
            remappings=[('imu', 'camera/imu'), ('topic_camera0', 'camera/infra1/image_rect_raw'), ('topic_camera1', 'camera/infra2/image_rect_raw')],
