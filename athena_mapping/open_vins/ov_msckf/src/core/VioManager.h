...
namespace ov_msckf {
    ...
    public:
        ...
        void feed_measurement_camera(const ov_core::CameraData &message) {
            ...
            if(camera_queue.size() > 2){
                ...
                std::cout << "WARNNING: camera queue size full " << camera_queue.size() << std::endl;
            }
        }
        ...
        /**
         * @brief Process function for slam
         */
        void imu_process();
    ...
    protected:
         ...
         * @param message Contains our timestamp, images, and camera ids
         */
        bool do_feature_propagate_update(const ov_core::CameraData &message);
        ...
        //sbh add
        Eigen::Matrix<double,16,1> pre_state_val;
